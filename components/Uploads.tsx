...
import { UploadCloud, FileText, Image as ImageIcon, X, Check, Loader2, FileCode, Paperclip, FileStack, Sparkles, Box, Truck, BarChart3, ChevronRight, PlusCircle } from 'lucide-react';
...
export const Uploads: React.FC<Props> = ({ onStartManual }) => {
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-blue-600 p-6 rounded-3xl text-white shadow-xl shadow-blue-600/20 flex flex-col justify-between h-full min-h-[140px]">
                                    ...
                                    <button 
                                        onClick={onStartManual}
                                        className="mt-4 w-full bg-white text-blue-600 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-50 transition-colors flex items-center justify-center gap-2 shadow-lg"
                                    >
