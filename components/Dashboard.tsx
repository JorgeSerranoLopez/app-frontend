  ...
  export const Dashboard: React.FC<Props> = ({ user, onStartQuote, onDeleteQuote, onGoUploads }) => {
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-8 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            {onGoUploads && (
              <button
                onClick={onGoUploads}
                className="bg-white/90 text-blue-600 px-4 py-3 rounded-xl font-bold shadow-lg hover:bg-blue-50 transition-all flex items-center gap-2"
              >
